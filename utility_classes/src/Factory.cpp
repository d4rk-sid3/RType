...
entity Factory::make_player()
{
    ...
    player_sprite.setTextureFromPath("assets/sprites/player/player.gif");
...
entity Factory::make_player_missile()
{
    ...
    missile_sprite.setTextureFromPath("assets/sprites/player/player_missile.gif");
...
entity Factory::make_enemy_missile()
{
    ...
    auto &missile_sprite = reg.add_component<component::drawable>(missile_id, component::drawable());
    missile_sprite.setTextureFromPath("assets/sprites/enemies/enemy_missile.gif");
...
entity Factory::make_red_trooper()
{
    ...
    troper_sprite.setTextureFromPath("assets/sprites/enemies/red_trooper.gif");
...
entity Factory::make_walker()
{
    ...
    troper_sprite.setTextureFromPath("assets/sprites/enemies/walker.gif");
...
entity Factory::make_ceiling()
{
    ...
    ceiling_sprite.setTextureFromPath("assets/sprites/background/ceiling.gif");
...
entity Factory::make_floor()
{
    ...
    floor_sprite.setTextureFromPath("assets/sprites/background/floor.gif");
...
entity Factory::make_wall()
{
    ...
    wall_sprite.setTextureFromPath("assets/sprites/bakcground/wall.gif");
...
entity Factory::make_background()
{
    ...
    background_sprite.setTextureFromPath("assets/sprites/background/background.jpg");
