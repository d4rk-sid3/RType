...
void ClientUI::init_date(void) {
    ...
    auto today_date = std::make_shared<TextElement>("date", "Gabriela-Regular.ttf", date, sf::Color::White, (sf::Vector2f){588.0, 195.0}, 17);
...
void ClientUI::init_hour(void) {
    ...
    auto dashboard_ui = UIManager::getInstance().getUI("Dashboardpage");
    hour = std::make_shared<TextElement>("Hour", "Gabriela-Regular.ttf", date, sf::Color::White, (sf::Vector2f){581.0, 151.0}, 27);
