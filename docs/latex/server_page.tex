...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classServer_aa37d52e1d2f14f8ca96a907d34e71b3f}{Server::Server}}(\textcolor{keywordtype}{int}\ p,\ \mbox{\hyperlink{classregistry}{registry}}\&\ regis)}
\DoxyCodeLine{\ \ \ \ :\ server\_(p,\ std::ref(messages),\ std::ref(mtx)),\ p\_(p),\ reg(regis)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{init__server_8cpp_a0c588e2ccf2ed315e2710776feac9eff}{load\_textures}}();}
