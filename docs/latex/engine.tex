...
It also uses pretty straightforward systems to update these components, as you can see in \doxylink{systems_8hpp}{systems.\+hpp}\hypertarget{engine_autotoc_md0}{}\doxysubsection{\texorpdfstring{}{}}\label{engine_autotoc_md0}
...
\end{DoxyItemize}\hypertarget{engine_autotoc_md1}{}\doxysubsubsection{\texorpdfstring{1. Initialize the Engine}{1. Initialize the Engine}}\label{engine_autotoc_md1}
...
\DoxyHorRuler{0}
 \hypertarget{engine_autotoc_md3}{}\doxysubsubsection{\texorpdfstring{2. Add the Components}{2. Add the Components}}\label{engine_autotoc_md3}
...
\DoxyHorRuler{0}
\hypertarget{engine_autotoc_md9}{}\doxysubsubsection{\texorpdfstring{3. Running the Game Loop}{3. Running the Game Loop}}\label{engine_autotoc_md9}
...
\DoxyHorRuler{0}
 \hypertarget{engine_autotoc_md11}{}\doxysubsubsection{\texorpdfstring{4. Behind the Scenes}{4. Behind the Scenes}}\label{engine_autotoc_md11}
...
\DoxyHorRuler{0}
 \hypertarget{engine_autotoc_md13}{}\doxysubsubsection{\texorpdfstring{5. Next Steps}{5. Next Steps}}\label{engine_autotoc_md13}
