...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classClient_a802e0a6f59303939f824d41580deb82a}{Client::Client}}(\textcolor{keywordtype}{int}\ port,\ std::string\ address,\ \mbox{\hyperlink{classregistry}{registry}}\&\ reg)}
\DoxyCodeLine{\ \ \ \ :\ port\_(port),}
\DoxyCodeLine{\ \ \ \ \ \ client\_(port,\ address,\ std::ref(lastmsg),\ std::ref(mtx)),}
\DoxyCodeLine{\ \ \ \ \ \ \_reg(reg)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{init__client_8cpp_a1957e9ebc2a88bc8e6c87fa64239c299}{load\_client\_textures}}();}
